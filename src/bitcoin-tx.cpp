...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Vanguardcoin Core vanguardcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vanguardcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vanguardcoin transaction") + "\n" +
              "  vanguardcoin-tx [options] -create [commands]   " + _("Create hex-encoded vanguardcoin transaction") + "\n" +
              "\n";

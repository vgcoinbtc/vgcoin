...
#if defined(NDEBUG)
# error "Vanguardcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Vanguardcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("vanguardcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Vanguardcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Vanguardcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)

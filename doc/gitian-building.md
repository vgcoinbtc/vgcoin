...
*Setup instructions for a Gitian build of Vanguardcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Vanguardcoin
...
- [Building Vanguardcoin](#building-vanguardcoin)
...
Clone the git repositories for vanguardcoin and Gitian and then checkout the vanguardcoin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/vanguardcoin-project/vanguardcoin.git
cd vanguardcoin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the vanguardcoin repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for Gitian to work offline.

Building Vanguardcoin
----------------

To build Vanguardcoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md) in the vanguardcoin repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/vanguardcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/vanguardcoin-project/vanguardcoin
...
For example:
```bash
URL=https://github.com/user/vanguardcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit vanguardcoin=${COMMIT} --url vanguardcoin=${URL} ../vanguardcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit vanguardcoin=${COMMIT} --url vanguardcoin=${URL} ../vanguardcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit vanguardcoin=${COMMIT} --url vanguardcoin=${URL} ../vanguardcoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/vanguardcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/vanguardcoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/vanguardcoin-build.assert
```
...
[vanguardcoin/gitian.sigs](https://github.com/vanguardcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
request. 
